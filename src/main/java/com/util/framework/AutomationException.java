...
public class AutomationException extends Exception{
	 ...
	 * @param reasonCd
	 */
	public AutomationException(String detailedMsg, Integer reasonCd) {
		super(detailedMsg);
	 ...
	 * @param reasonCd
	 */
	public AutomationException(String detailedMsg, Throwable t, Integer reasonCd) {
		super(detailedMsg, t);
		this.reasonCode = reasonCd;
	}
	
	public AutomationException(String detailedMsg, Integer reasonCd, String purveyorId, String orderId) {
		super(detailedMsg);
		this.reasonCode = reasonCd;
	}
